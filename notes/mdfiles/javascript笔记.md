...
> `function name(参数 1, 参数 2, 参数 3) {执行代码}`
...
> `var name = function(参数 1, 参数 2, 参数 3) {要执行的代码}`
>    
> var name = new Function("参数1,参数2,......","代码块")
>
> 使用 `new` 创建函数两个参数都为字符串类型，最后一个参数为执行代码
...
> **arguments** 是函数本身自带的属性，他用于返回接受到的所有参数，是一个类数组，并不是数组类型
...
> 若传入的实参多于形参，**arguments** 仍然会获取所有的实参

```js
function func(a, b) {
    console.log(a);
    console.log(b);
    console.log(arguments); // [0,5,10,20]
}
func(0,5,10,20)
```
...
> 1.
>
> ![0](data:image/gif;base64,)
>
> 2.
>
...
* 捕获阶段
  ...
  事件从 `window` 开始，逐级向下传播到目标元素（子元素）。

* 冒泡阶段

  事件从目标元素（子元素）开始，逐级向上传播到父元素（`div`）。
...
>
> 文件控件节点 input 的files属性，返回一个 FileList 实例。
...
let name = "张三"
let str = `名字是:${msg(name)}`
console.log(str); // 名字是:张三
```

> 标签模板（Tagged Templates）
>
> 是JavaScript中模板字符串的一个高级特性，它允许你通过函数来处理模板字符串。

```js
function tag(strings, ...values) {
    console.log(strings); // 第一个参数是一个数组
    console.log(values);  // 其余参数是模板字符串中表达式的值
    return "模板字符串被处理了!";
}
...
console.log(result); // 输出: 模板字符串被处理了!
// 同时，控制台还会打印出strings和values数组的内容
```

> `function tag(strings, ...values)`中的 **strings** 参数就是被 `${}`所分割的原本字符串，**values** 就是`${}`内的内容
...
>
> 使用扩展符必须是最后一位 `...`，`Rest element must be last element`
